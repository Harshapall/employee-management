...
@media (max-width:500px) {
    ...
    <?php
         if(isset($_POST['settingdate']))
         {
            include('config.php');
             ...
             echo "date entered:";
             echo $dater;
             $query="UPDATE emp_sairap SET dates='$dater'";
    ...
    <div class="charts">
                  <div class="chart"">
                  <h4 style="text-align:center">---------------SAI / RAPTOR PAGE--------------<h4>
                     ...
                     <form   method="post" class="Dateplace">
                        ...
                        <a href="report_sairap.php" class="rep_btn">SAVE TO DAILY REPORT</a>
                  <div>
                    <div style="float:left">
                        ...
                        <?php 
                            ...
                            if(isset($_POST['search']))
                            {
                                ...
                                // mysql search query
                                $query = "SELECT * FROM `emp_sairap` WHERE `id` = $id LIMIT 1";
                                    ...
                                    {  
                                                echo "  
                                                    ...
                                                    <td>".$i++."</td>   
                                                        ...
                                                        <td>".$row['service']."</td>
                                                        <td>".$row['dates']."</td>
                                                        <td><a href='update_sairap.php?id=".$row['id']."' class='button''>Update</a></td>
                                                        <td><a href='delete_sairap.php?id=".$row['id']."' class='button4'>Delete</a></td>  
                                                    </tr>  
                                                ";  
                                        }  
                                }
    ...
    <div class="charts2">
                <div class="chart2">
                <h2>SIVA SAI / RAPTOR Shift Details</h2>
                                    ...
                                    while ($result = mysqli_fetch_assoc($run)) {  
                                        echo "  
                                            ...
                                            <td>".$i++."</td>  
                                                ...
                                                <td>".$result['dates']."</td>
                                                <td><a href='update_sairap.php?id=".$result['id']."' class='button''>Update</a></td>
                                                <td><a href='delete_sairap.php?id=".$result['id']."' class='button4'>Delete</a></td>  
                                            </tr>  
                                        ";  
                                    }  
                            }  
