...
.Dateplace{
    ...
    <div class="charts">
                <div class="chart"">
                <h4 style="text-align:center">---------------SIVA SAI / RAPTOR REPORT PAGE--------------<h4>
                     <a href="Sairaptor.php" class="backer">--->SAI / RAPTORL</a>
                     ...
                     <form  method="post" class="Dateplace">
                        ...
                        <?php 
                            ...
                            if(isset($_POST['settingdate']))
                            {
                                ...
                                // mysql search query
                                $query = "SELECT * FROM `emp_sairap` WHERE `dates` = '$dater'";
                                    ...
                                    {  
                                                echo "  
                                                    ...
                                                    <td>".$i++."</td>  
                                                        ...
                                                        <td>".$row['service']."</td>
                                                        <td>".$row['dates']."</td>
                                                        <td><a href='updaterep_sairap.php?id=".$row['id']."' class='button''>Update</a></td>
                                                        <td><a href='deleterep_sairap.php?id=".$row['id']."' class='button4'>Delete</a></td>  
                                                    </tr>  
                                                ";  
                                        }  
                                }
