...
<?php   
 include 'config.php'; 
 if(count($_POST)>0) {
    mysqli_query($con,"UPDATE report_sairap set id='" . $_POST['id'] . "', name='" . $_POST['name'] . "', shift='" . $_POST['shifts'] . "', hour='" . $_POST['hour'] . "' ,location='" . $_POST['locate'] . "',shoot='" . $_POST['shoot'] . "' ,service='" . $_POST['contracter'] . "',dates='" . $_POST['date'] . "' WHERE id='" . $_POST['id'] . "'");
    } 
 if (isset($_GET['id'])) {  
      $id = $_GET['id'];  
      $query = "SELECT * FROM `report_sairap` WHERE id = '$id'";  
